...
public class SaveMediaItemsHandler(ILogger<SaveMediaItemsCommand> logger, IFileService minio, IMediaService mongo) : IRequestHandler<SaveMediaItemsCommand, bool>
{
